...
export class AddTBLOrders1759437252630 implements MigrationInterface {
    name = 'AddTBLOrders1759437252630'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "shippings" ("id" SERIAL NOT NULL, "phone" character varying NOT NULL, "name" character varying NOT NULL DEFAULT '', "address" character varying NOT NULL DEFAULT '', "city" character varying NOT NULL, "postCode" character varying NOT NULL, "country" character varying NOT NULL, "state" character varying NOT NULL, CONSTRAINT "PK_665fb613135782a598a2b47e5b2" PRIMARY KEY ("id"))`);
